...
<tr>
 ...
 <?php
        ...
        { $d= $donnee['forum_id'];
            ...
            echo '<tr> 
            <td id="name"><a href="forumadmin/goForum?f='.$d.'">'.$donnee['forum_name'].'</a> </td>             
            ...
            if(isset($_SESSION["Admin"]))
{
 ...
 <form method="post"  action="forumadmin/supForum?f='.$d.'">
...
if(isset($_SESSION["Admin"]))
{
echo '<a href="forumadmin/newForum">ajouter un nouveau forum</a> ';
}
